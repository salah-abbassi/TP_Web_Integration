 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://banque_soap.example.org/", wsdlLocation = "http://localhost:9001/banque?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://banque_soap.example.org/", "BanqueServiceService");
    ...
    public IBanque getBanqueServicePort() {
        return super.getPort(new QName("http://banque_soap.example.org/", "BanqueServicePort"), IBanque.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueServicePort")
    public IBanque getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://banque_soap.example.org/", "BanqueServicePort"), IBanque.class, features);
    }
